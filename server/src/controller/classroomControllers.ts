...
const getAllClassrooms = async (request: Request, response: Response) => {
...
const getClassroom = async (request: Request, response: Response) => {
...
const getClassroomStudents = async (request: Request, response: Response) => {
    const idClassroom = Number(request.params.id)
    const { search } = request.query
...
const getClassroomStudent = async (request: Request, response: Response) => {
    const idClassroom = Number(request.params.id)
...
const createClassroom = async (request: Request, response: Response) => {
...
const updateClassroom = async (request: Request, response: Response) => {
    const idClassroom = Number(request.params.id)
    const { description } = request.body
...
const getClassroomAttendance = async (request: Request, response: Response) => {
    const idClassroom = Number(request.params.id)
...
const saveClassroomAttendance = async (request: Request, response: Response) => {
    const idClassroom = Number(request.params.id)
...
const getClassroomTests = async (request: Request, response: Response) => {
    const idClassroom = Number(request.params.id)
    const { date } = request.query
...
const getClassroomTest = async (request: Request, response: Response) => {
    const idClassroom = Number(request.params.id)
...
const createClassroomTest = async (request: Request, response: Response) => {
    const idClassroom = Number(request.params.id)
...
const updateClassroomTest = async (request: Request, response: Response) => {
    const idClassroom = Number(request.params.id)
    const idTest = Number(request.params.test)
    const { description, date, students } = request.body
...
const addStudentToClassroom = async (request: Request, response: Response) => {
    const idClassroom = Number(request.params.id)
    const idStudent = Number(request.params.student)
...
const removeStudentToClassroom = async (request: Request, response: Response) => {
    const idClassroom = Number(request.params.id)
    const idStudent = Number(request.params.student)
...
const addProfessorToClassroom = async (request: Request, response: Response) => {
    const idClassroom = Number(request.params.id)
...
const removeProfessorToClassroom = async (request: Request, response: Response) => {
    const idClassroom = Number(request.params.id)
    const idProfessor = Number(request.params.professor)
