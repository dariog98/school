...
create table student_subject (
    ...
    unique key uq_student_subject_student_id_class_id (student_id, subject_id)
);
...
create table professor_subject (
    ...
    unique key uq_professor_subject_professor_id_class_id (professor_id, subject_id)
);
...
create table attendances (
    ...
    unique key uq_attendances_student_id_subject_id_date (student_id, subject_id, date)
);
...
create table student_test (
    ...
    unique key uq_student_test_student_id_test (student_id, test_id)
);
